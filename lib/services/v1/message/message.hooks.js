...
const SetCreatedByQuery_1 = __importDefault(require("../../../hooks/SetCreatedByQuery"));
// Don't remove this comment. It's needed to format import lines nicely.
const { authenticate } = authentication.hooks;
exports.default = {
    before: {
        all: [authenticate('jwt')],
        find: [(0, SetCreatedByQuery_1.default)()],
        get: [],
        create: [(0, SetDefaultItem_1.default)('status', Status_1.ACTIVE), (0, SetCreatedBy_1.default)(), (0, CheckAndCreateChat_1.default)(), (0, CreateBotMessage_1.default)()],
        update: [],
        patch: [],
        remove: []
    },
    after: {
        ...
        find: [],
        get: [],
        create: [(0, IncludeMessagesCount_1.default)(), (0, IncludeBotResponse_1.default)()],
        update: [],
        patch: [],
        remove: []
    },
